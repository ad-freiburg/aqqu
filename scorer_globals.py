...
scorer_list = [ranker.AqquModel('F917_Ranker',
               ...
               ranker.AqquModel('F917_EQL_Ranker',
                                ...
                                top_ngram_percentile=10,
                                rel_regularization_C=1e-6),
               ranker.AqquModel('F917_Ranker_no_types',
                                ["free917train"],
                                top_ngram_percentile=10,
                                rel_regularization_C=1e-6,
                                use_type_names=False),
               ranker.AqquModel('F917_Ranker_no_attention',
                                ["free917train"],
                                top_ngram_percentile=10,
                                rel_regularization_C=1e-6,
                                use_type_names=True,
               ...
               ranker.AqquModel('F917_WQSP_Ranker',
                                ["free917train", "wqsptrain"],
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5),
               ranker.AqquModel('WQSP_F917_Ranker',
                                ["wqsptrain", "free917train"],
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5),
               ...
               ranker.AqquModel('WQ_Ranker',
                                ...
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5),
               ranker.AqquModel('WQ_Ranker_no_types',
                                ["webquestionstrain"],
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5,
                                use_type_names=False),
               ranker.AqquModel('WQ_Ranker_no_attention',
                                ["webquestionstrain"],
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5,
                                use_type_names=True,
               ...
               ranker.AqquModel('WQ_Ranker_1of2',
                                ...
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5),
               ranker.AqquModel('WQ_Ranker_EQL',
                                ["webquestionstrain"],
                                entity_linker_class=EntityLinkerQlever,
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5),
               ...
               ranker.AqquModel('SQ_Ranker',
                                ...
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5),
               ranker.AqquModel('SQ_Ranker_no_types',
                                ["sqtrain"],
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5,
                                use_type_names=False),
               ...
               ranker.AqquModel('WQSP_Ranker',
                                ...
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5),
               ranker.AqquModel('WQSP_Ranker_no_types',
                                ["wqsptrain"],
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5,
                                use_type_names=False),
               ranker.AqquModel('WQSP_Ranker_no_attention',
                                ["wqsptrain"],
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5,
                                use_type_names=True,
               ...
               ranker.AqquModel('WQSP_Ranker_EQL',
                                ["wqsptrain"],
                                entity_linker_class=EntityLinkerQlever,
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5),
               ranker.AqquModel('WQSP_Ranker_tiny',
                                ...
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5),
               ranker.AqquModel('WQSP_Ranker_EQL_tiny',
                                ["wqsptrain_tiny"],
                                entity_linker_class=EntityLinkerQlever,
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5),

               ranker.AqquModel('SQ_WQSP_Ranker_tiny',
                                ["sqtrain_tiny", "wqsptrain_tiny"],
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5),
               ranker.AqquModel('SQ_WQSP_Ranker_tiny_no_types',
                                ["sqtrain_tiny", "wqsptrain_tiny"],
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5,
                                use_type_names=False),
               ranker.AqquModel('SQ_WQSP_Ranker_tiny_no_attention',
                                ["sqtrain_tiny", "wqsptrain_tiny"],
                                top_ngram_percentile=5,
                                rel_regularization_C=1e-5,
                                use_type_names=True,
